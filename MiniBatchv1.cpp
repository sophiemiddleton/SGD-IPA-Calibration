...
#include <ctime>
using namespace std;
double FVAL=0; //loss value at point in time
int N_EVENTS = 10000;
int N_CONVERGED;
int N_CRYSTALS = 674;
int N_MINIBATCH =1;
...
std::vector<double> MiniBatchIncrementalGradientDescent(std::vector<Event> epoch, int batch, std::vector<double> constants, std::vector<double> seed_constants, double& FVAL){
     double old_c ;
    double new_c ;
    double dc;
    double dFdVm;
